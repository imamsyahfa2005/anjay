...
/////////////////
const BotName = '♨️IS-BOT♨️'; 
const instagram = 'https://instagram.com/serenyemnyem'; 
const telegram = 'https://www.instagram.com/p/CCd6JSRJtNr/?igshid=1lrx42kl14t7k'; 
const kapanbotaktif = '19.30-23.00 AM🌃'; 
const youtube = 'https://www.facebook.com/mhmd.ikbar';
const grupch1 = 'https://chat.whatsapp.com/HaT3rqLA0RBGjePOh0HgGG'; // OFFICIAL GRUP LU 1
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@serenyemnyem')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => Bot by ig:@serenyemnyem`)
})
